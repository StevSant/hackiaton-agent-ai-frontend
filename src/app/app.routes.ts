...
export const routes: Routes = [
  { path: '', pathMatch: 'full', component: AgentList, canActivate: [AuthGuard] },
  // More specific route first to allow session deep-linking
  { path: 'chat/:agentId/session/:sessionId', component: Chat, canActivate: [AuthGuard] },
  { path: 'chat/:agentId', component: Chat, canActivate: [AuthGuard] },
  // Voice-first chat routes
  { path: 'audio/:agentId/session/:sessionId', component: AudioChat, canActivate: [AuthGuard] },
